package com.gunawan.MY_UAS;

public class Konfigurasi {
    public static final String URL_ADD="http://192.168.1.4/haji/add.php";
    public static final String URL_GET_ALL="http://192.168.1.4/haji/show_all.php";
